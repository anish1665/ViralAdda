package com.ronak.viral.adda.providers.soundcloud.player.media;
...
import com.ronak.viral.adda.providers.soundcloud.player.remote.RemoteControlClientCompat;
import com.ronak.viral.adda.providers.soundcloud.player.remote.RemoteControlHelper;
...
public class MediaSessionWrapper {
     ...
     */
    static final String ACTION_TOGGLE_PLAYBACK = "com.ronak.viral.adda.providers.soundcloud.library.media.TOGGLE_PLAYBACK";
     ...
     * Action used to catch broadcast from {@link MediaSessionReceiver}
     */
    static final String ACTION_PREVIOUS_TRACK = "com.ronak.viral.adda.providers.soundcloud.library.media.PREVIOUS_TRACK";
